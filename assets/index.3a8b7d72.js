...
`,ve=s.div`
   ...
   gap: 1em;
   margin-top: .5em;
`,mn={hidden:{opacity:0},visible:{opacity:1,scale:1,transition:{delayChildren:0,staggerChildren:.3}}},pn={hidden:{y:20,opacity:0},visible:{y:0,opacity:1}},ct=({children:t})=>e(f.div,{variants:mn,initial:"hidden",animate:"visible",children:t}),gn=({children:t})=>e(f.div,{variants:pn,children:t}),lt=({i:t,length:o,component:i})=>{const n=t%2===0,r=o===t+1;return e(gn,{children:n?a(Ee,{children:[i,a("span",{children:[e(Me,{children:e(Ce,{})}),!r&&e(Pe,{})]}),e("span",{})]}):a(Ee,{children:[e("span",{}),a("span",{children:[e(Me,{children:e(Ce,{})}),!r&&e(Pe,{})]}),i]})})},dt=(t,o,i)=>{const[n,r]=v.exports.useState(t);return[n,r,u=>{r(S(g({},n),{[u.target.name]:u.target.value}))},u=>{r(S(g({},n),{[u]:""}))},()=>{r(t),o&&i&&(o(""),i(""))}]},hn=({id:t,name:o,start:i,end:n})=>{const{mutate:r,isLoading:c}=un(),l=F(i).format("DD/MM/YYYY"),d=F(n).format("DD/MM/YYYY"),u=x();return a(st,{children:[e(ee,{children:o}),a(D,{small:!0,children:[l," - ",d]}),a(ve,{children:[a(m,{onClick:()=>{u(po({id:t,name:o,start:i,end:n}))},children:[e(Tt,{})," Editar"]}),a(m,{color:"red",onClick:()=>{r(t),u(_())},children:[" ",c?e(y,{}):e(de,{})," Eliminar"]})]})]})},fn=()=>{const t=R(T=>T.education.active),o=x(),[i,n]=v.exports.useState(),[r,c]=v.exports.useState(),[{name:l},d,u,h,k]=dt({name:""},n,c),{data:E,isLoading:Y}=rt(),{mutate:B,isLoading:M}=sn(),{mutate:L,isLoading:C}=ln();v.exports.useEffect(()=>{t?(d(t),n(t.start),c(t.end)):k()},[t]);const P=T=>{T.preventDefault(),t?L({id:t.id,name:l,start:i,end:r},{onSuccess:()=>o(_())}):B({name:l,start:i,end:r},{onSuccess:()=>k()})};return a(bn,{children:[e(Ae,{children:Y?e(G,{}):E.length!==0?e(ct,{children:E.map((T,ft)=>e(lt,{i:ft,length:E.length,component:e(hn,g({},T))},T.id))}):e(V,{children:"Ingresa tu estudios"})}),a(pe,{onSubmit:P,children:[e(j,{children:"Cuales son tus estudios?"}),e(U,{type:"text",icon:e(Dt,{}),name:"name",label:"Escuela",value:l,onChange:u,reset:h}),a(nn,{children:[e(Ie,{name:"start",date:i,setDate:n}),e(Ie,{name:"end",date:r,setDate:c})]}),a(ge,{children:[t?a(m,{children:[" ",C?e(y,{}):e(ue,{})," Actualizar"]}):a(m,{children:[" ",M?e(y,{}):e(me,{})," Guardar"]}),t&&e(m,{onClick:()=>o(_()),children:"Cancelar"})]})]})]})},bn=s.div`
   position: relative;
`,Z="portfolio",An=()=>W("/portfolio"),ut=()=>le([Z],An),vn=t=>I("/portfolio","POST",t),xn=()=>{const t=w();return b(vn,{onSuccess:o=>{p.success("Proyecto agregado"),t.setQueryData([Z],i=>[...i,o])}})},yn=t=>Ze(`/uploads/portfolio/${t.id}`,"POST",t),wn=()=>{const t=w();return b(yn,{onSuccess:o=>{p.success("Imagen agregada"),t.setQueryData([Z],i=>i.map(n=>n.id===o.id?o:n))}})},kn=t=>I(`/portfolio/${t.id}`,"PUT",t),Cn=()=>{const t=w();return b(kn,{onSuccess:o=>{p.success("Proyecto actualizado"),t.setQueryData([Z],i=>i.map(n=>n.id===o.id?o:n))}})},Sn=t=>I(`/portfolio/${t}`,"DELETE"),In=()=>{const t=w();return b(Sn,{onSuccess:o=>{p.success("Proyecto eliminado"),t.setQueryData([Z],i=>i.filter(n=>n.id!==o.id))}})},En=({id:t,img:o,name:i,description:n,link:r})=>{const c=x(),l=R(M=>M.portfolio.active),{mutate:d,isLoading:u}=In(),{mutate:h,isLoading:k}=wn(),E=()=>{c(fe({id:t,img:o,name:i,description:n,link:r}))},Y=()=>{d(t),c(O())},B=M=>{const L=new FormData;L.append("file",M.target.files[0]),h({id:t,file:L},{onSuccess:()=>c(O())})};return a(Ln,{children:[k?e(Mn,{children:e(y,{})}):e(Pn,{src:o,alt:i,onClick:E}),!k&&l&&l.id===t&&a(Tn,{children:[e(Dn,{children:i}),e(Te,{smaill:!0,children:n}),e(Te,{smaill:!0,children:r}),a(m,{color:"red",onClick:Y,children:[u?e(y,{}):e(de,{})," Eliminar"]}),e(it,{text:"Agregar imagen",onChange:B}),e(m,{onClick:()=>c(O()),children:"Cancelar"})]})]})},Mn=s.div`
  display: flex;
  justify-content: center;
  align-items: center;
  width: 100%;
...
`,Ln=s.div`
    position: relative;
`;const mt=({children:t})=>e(Lt,{effect:"coverflow",grabCursor:!0,centeredSlides:!0,slidesPerView:"auto",loop:!0,pagination:!0,modules:[Ut,Yt],coverflowEffect:{rotate:50,stretch:0,depth:100,modifier:1,slideShadows:!0},children:t}),Un={hidden:{opacity:0,x:"-10vw"},visible:{opacity:1,x:0,transition:{type:"spring",stiffness:100}},exit:{opacity:0,x:"10vw",transition:{type:"easeInOut"}}},pt=({children:t})=>e(f.div,{variants:Un,initial:"hidden",animate:"visible",exit:"exit",children:t}),Yn=()=>{const t=x(),o=R(C=>C.portfolio.active),[{name:i,description:n,link:r},c,l,d,u]=dt({name:"",description:"",link:""}),{data:h,isLoading:k}=ut(),{mutate:E,isLoading:Y}=xn(),{mutate:B,isLoading:M}=Cn();v.exports.useEffect(()=>{o?c(o):u()},[o]);const L=C=>{C.preventDefault(),o?B({id:o.id,name:i,description:n,link:r},{onSuccess:()=>t(O())}):E({name:i,description:n,link:r},{onSuccess:P=>t(fe(P))})};return a(z,{children:[e(Ae,{children:k?e(G,{}):h.length!==0?e(pt,{children:e(mt,{children:h.map(C=>e(Fe,{className:"portfolio__card",children:e(En,g({},C))},C.id))})}):e(V,{children:"Ingresa tus proyectos"})}),a(pe,{onSubmit:L,children:[e(j,{children:"Cuales son tus proyectos?"}),e(U,{type:"text",icon:e(Oe,{}),name:"name",value:i,label:"Nombre",onChange:l,reset:d}),e(U,{type:"text",icon:e(Re,{}),name:"description",value:n,label:"Descripcion",onChange:l,reset:d}),e(U,{type:"text",icon:e(Bt,{}),name:"link",value:r,label:"Link (opcional)",onChange:l,reset:d}),e(ge,{children:o?a(m,{margin:!0,children:[" ",M?e(y,{}):e(ue,{})," Actualizar"]}):a(m,{margin:!0,children:[" ",Y?e(y,{}):e(me,{})," Guardar"]})})]})]})},Bn=()=>e(Qe,{children:a(A,{path:"/",element:e(ko,{}),children:[e(A,{index:!0,element:e(_o,{})}),e(A,{path:"education",element:e(fn,{})}),e(A,{path:"portfolio",element:e(Yn,{})}),e(A,{path:"*",element:e(ce,{to:"/dashboard/"})})]})}),jn=s.div`
  background-image: url(${be}) ;
  background-blend-mode: soft-light;
  background-color: rgba(0,0,0,.7);
  background-repeat: no-repeat;
...
`,gt=({children:t,noPadding:o})=>a(jn,{children:[e("div",{}),e(De,{}),e("div",{}),e(De,{}),e(On,{noPadding:o,children:t})]}),Rn=s.nav`
  width: 100%;
  display: flex;
  justify-content: space-between;
  padding: .5em 1em;
...
`,zn=s.div`
  display: flex;
  align-items: center;
`,Fn=()=>a(Rn,{children:[e(jt,{to:"/auth",children:e(Ke,{src:He,alt:"logo carlitos"})}),a(zn,{children:[a(J,{to:"/",children:[e(Ot,{}),e("span",{children:"Inicio"})]}),a(J,{to:"/education",children:[e(Ue,{}),e("span",{children:"Educacion"})]}),a(J,{to:"/portfolio",children:[e(Ye,{}),e("span",{children:"Portafolio"})]})]})]}),Qn=()=>e(z,{children:a(gt,{children:[e(Fn,{}),e(Be,{})]})}),ht=s.div`
...
`;var $n="/assets/cv_carlos.6cd29141.pdf";const qn=()=>e(Rt,{makeDefault:!0,fov:12,position:[-10,5,-5]});function Xn(o){var t=ke(o,[]);const i=v.exports.useRef(),{nodes:n,materials:r}=Ve("/micro/scene.gltf");return e("group",S(g({ref:i},t),{dispose:null,children:e("group",{rotation:[-Math.PI/2,0,0],children:a("group",{rotation:[Math.PI/2,0,0],children:[e("mesh",{geometry:n.defaultMaterial.geometry,material:n.defaultMaterial.material}),e("mesh",{geometry:n.defaultMaterial_1.geometry,material:n.defaultMaterial_1.material}),e("mesh",{geometry:n.defaultMaterial_2.geometry,material:n.defaultMaterial_2.material}),e("mesh",{geometry:n.defaultMaterial_3.geometry,material:n.defaultMaterial_3.material}),e("mesh",{geometry:n.defaultMaterial_4.geometry,material:n.defaultMaterial_4.material}),e("mesh",{geometry:n.defaultMaterial_5.geometry,material:n.defaultMaterial_5.material}),e("mesh",{geometry:n.defaultMaterial_6.geometry,material:n.defaultMaterial_6.material}),e("mesh",{geometry:n.defaultMaterial_7.geometry,material:n.defaultMaterial_7.material}),e("mesh",{geometry:n.defaultMaterial_8.geometry,material:n.defaultMaterial_8.material}),e("mesh",{geometry:n.defaultMaterial_9.geometry,material:n.defaultMaterial_9.material}),e("mesh",{geometry:n.defaultMaterial_10.geometry,material:n.defaultMaterial_10.material}),e("mesh",{geometry:n.defaultMaterial_11.geometry,material:n.defaultMaterial_11.material}),e("mesh",{geometry:n.defaultMaterial_12.geometry,material:n.defaultMaterial_12.material}),e("mesh",{geometry:n.defaultMaterial_13.geometry,material:n.defaultMaterial_13.material}),e("mesh",{geometry:n.defaultMaterial_14.geometry,material:n.defaultMaterial_14.material}),e("mesh",{geometry:n.defaultMaterial_15.geometry,material:n.defaultMaterial_15.material}),e("mesh",{geometry:n.defaultMaterial_16.geometry,material:n.defaultMaterial_16.material})]})})}))}Ve.preload("/micro/scene.gltf");const _n=()=>a(zt,{children:[e(qn,{}),e("pointLight",{color:"#0000ff",position:[10,-5,5]}),e("pointLight",{color:"#0000ff",position:[50,10,-10]}),e("pointLight",{color:"#ffffff",position:[0,0,100]}),a(v.exports.Suspense,{fallback:null,children:[e(Xn,{}),e(Ft,{files:"/hdr/decor_shop_1k.jpg",preset:"night"})]}),e(Qt,{enablePan:!1,autoRotate:!0,enableZoom:!1})]}),Wn=()=>{const{data:t,isLoading:o}=nt();return a(Jn,{children:[e(Kn,{children:e(_n,{})}),e(ht,{children:o?e(y,{}):t[0]&&a(Vn,{children:[t[0].img?e(X,{src:t[0].img,alt:"imagen de usuario"}):e(X,{src:at,alt:"Imagen por defecto"}),a(Nn,{children:[e(H,{children:t[0].name}),e(D,{children:t[0].description}),e(m,{as:"a",style:{fontWeight:"normal",fontSize:".9em"},href:$n,download:"cv_carlos.pdf",children:"Descargar CV"})]})]})}),e("div",{}),e(Gn,{}),a(Zn,{children:[a("div",{children:[e("h6",{children:"Instagram"}),e(D,{small:!0,children:"danieel.u"})]}),a("div",{children:[e("h6",{children:"Correo"}),e(D,{small:!0,children:"daniusqueda582@gmail.com"})]}),a("div",{children:[e("h6",{children:"Telefono"}),e(D,{small:!0,children:"2945-550890"})]})]})]})},Hn=({name:t,start:o,end:i})=>{const n=F(o).format("MM/YYYY"),r=F(i).format("MM/YYYY");return a(st,{children:[e(ee,{children:t}),e(D,{small:!0,children:a(lo,{children:[e(ze,{}),n," - ",r]})})]})},ei=()=>{const{data:t,isLoading:o}=rt();return a(Je,{children:[e(j,{margin:!0,children:"Estudios"}),o?e(G,{}):t.length!==0?e(ct,{children:t.map((i,n)=>e(lt,{i:n,length:t.length,component:e(Hn,g({},i))},i.id))}):e(V,{children:"No hay estudios que mostrar"})]})},ti=({id:t,img:o,name:i,description:n,link:r})=>{const c=x(),l=R(h=>h.portfolio.active),d=()=>{c(fe({id:t,img:o,name:i,description:n,link:r}))},u=()=>{c(O())};return a(ri,{children:[e(oi,{src:o,alt:i,onClick:d}),l&&l.id===t&&a(ii,{children:[e(ee,{children:i}),e(D,{smaill:!0,children:n}),r&&e(ni,{href:r,target:"_blank",children:a(m,{children:[e(je,{}),"Ver proyecto"]})}),e(ai,{onClick:u,children:e(Vt,{})})]})]})},oi=s.img`
  display: block;
  width: 100%;
  height: 350px;
  object-fit: cover;
...
`,ri=s.div`
    position: relative;
`,si=()=>{const{data:t,isLoading:o}=ut();return a(Je,{children:[e(j,{margin:!0,children:"Proyectos"}),o?e(G,{}):t.length!==0?e(pt,{children:e(mt,{children:t.map(i=>e(Fe,{className:"portfolio__card",children:e(ti,g({},i))},i.id))})}):e(V,{children:"No hay proyectos que mostrar"})]})},ci=()=>{const t=Le(),[{email:o,password:i},n,r]=et({email:"",password:""}),{mutate:c}=to();return e(gt,{children:a(li,{onSubmit:d=>{d.preventDefault(),c({email:o,password:i},{onSuccess:()=>{t("/dashboard")}})},children:[e(j,{children:"Inicia Sesion"}),e(U,{type:"text",name:"email",label:"Correo electronico",value:o,onChange:n,reset:r}),e(U,{name:"password",label:"Contrase\xF1a",value:i,onChange:n,reset:r}),e(m,{children:"Enviar"})]})})},li=s.form`
   width: 90%;
   max-width: 400px;
   margin: 6em auto;
...
`,di=()=>{const{user:t}=R(o=>o.auth);return e(Nt,{children:a(Qe,{children:[a(A,{path:"/",element:e(Qn,{}),children:[e(A,{index:!0,element:e(Wn,{})}),"k",e(A,{path:"education",element:e(ei,{})}),e(A,{path:"portfolio",element:e(si,{})}),e(A,{path:"*",element:e(ce,{to:"/"})})]}),e(A,{path:"/auth",element:e(ci,{})}),e(A,{path:"/dashboard/*",element:e(so,{isLogged:!!t,children:e(Bn,{})})})]})})},ui=({children:t})=>{const o=new Gt({defaultOptions:{queries:{retry:1,refetchOnWindowFocus:!1}}});return a(Zt,{client:o,children:[t,e(Kt.exports.ReactQueryDevtools,{})]})},mi=Jt({reducer:{about:mo,auth:Ht,education:go,experience:fo,portfolio:bo}}),pi=({children:t})=>e($t,{store:mi,children:t}),gi=()=>e(qt,{toastOptions:{style:{background:"rgba(0,0,0,.5)",backdropFilter:"blur(25px)",boxShadow:"0 0 3px #fff",color:"#fff"}}}),hi=()=>a(pi,{children:[e(ui,{children:e(di,{})}),e(gi,{})]});Xt(document.getElementById("root")).render(e(hi,{}));
